...
if(isset($_POST["vom"])){
    ...
    $num+=1;
    $sql="INSERT INTO Question"."(QID,Q_Content,email,A_Content,S_Account) VALUES('$num','".$content."','$mail','','')";
    if(!mysqli_query($conn,$sql)){
               echo"<script>
            alert('回覆失敗，請再試一次！');</script>";
            }
            else{
                echo "<script>
            alert('感謝您的提問，我們將盡快回覆您');</script>";
...
<body style=background:#000000>
    ...
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                <div class=logo>
                    <a href=https://cn.pornhub.com /><img src="https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg"></a>
                </div>
                ...
                <ul class=member>
                    ...
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href=SignUp.php></a>
                    <li class=top_btn_recommend><span id=topBar_light_2 style=display:none></span><a href="filmy_all.php"></a>
                    <li class=top_btn_head><span id=topBar_light_1 style=display:none></span><a href="personal.php"></a>
    ...
    <nav style=background:#000000 class="mainmenu on_top">
        ...
        <div style=background:#000000 class=container-player>
            ...
            <ul>
                <li style=background:#000000><a href="homePage/Homepage.html">首頁</a></li>
                <li style=background:#000000><a href="filmy_no_like.php">所有影音</a></li>
                <li style=background:#000000><a href="filmy_mine.php">觀看記錄</a></li>
                <li style=background:#000000><a href="charge.php">付費方案</a></li>
                <li style=background:#FFCC6E><a href="常見問題new.php">常見問題</a></li>
                <li style=background:#000000><a href="問題回報New.php" >問題回報</a></li>
            </ul>
        </div>
    </nav>
       ...
       <br><br> <hr width="60%"><br><br>
        ...
        <div class="two-cols">
            ...
            <div class="c-col">
                ...
                <br><input type="input" class="form-control" id="problem" name ="problem" style="font-size:42px">
				  <button type="submit" class="bt" id="vom"name="vom"><span> 送出</span></button>
					</form>
					</div>
                </div>
            </div>
    			...
    			if($("#problem").val() == '' ){
    				...
    				$("div.loading").html('');
					  ...
					  //使用 ajax 送出 帳密給 verify_user.php
						$.ajax({
	            type : "POST",
	            url : "常見問題new.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
