    ...
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            ...
            <ul>
                ...
                <li style=background:#FFCC6E><a href="filmy_mine.php">觀看記錄</a></li>
...
if(!mysqli_query($conn,$str)){
            ...
            $mail=$_COOKIE["email"];
            $sql="Select F.Route,F.FilmName,F.ClickTimes,F.DueDate,F.Photo From Film_Buy F,Record R WHERE R.email='".$mail."' AND R.FilmName=F.FilmName";
