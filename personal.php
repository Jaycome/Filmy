    ...
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                ...
                <ul class=member>
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href="homePage/Homepage.html"></a>
    ...
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            ...
            <ul>
                ...
                <li style=background:#000000><a href="問題回報New.php" target=_blank>問題回報</a></li>
            </ul>
        </div>
    </nav>
                    ...
                    <div class=form__wrap>
                        ...
                        <div class=form__multiple>
                            ...
                            <div class=form__multiple__input>
                                <input id=edit-nick-input class=is-text type=text data-nick=小紅 value="<? echo $Little ?>" maxlength=20 placeholder=來個新名字吧(ゝ∀･) disabled>
                                <a id=edit-nick href="personal_result.php" class=edit-btn>編輯</a>
                            </div>
                            <div id=edit-nick-text class="form__status is-warning" style=display:none>
                                十個中文字內，請避免使用特殊符號。
                            </div>
                            <div id=edit-nick-options class=form__option style=display:none>
                        ...
                        <div class=form__multiple>
                            <label for>信箱</label>
                            <div class=form__multiple__input>
                                <input type=text disabled value="<? echo $mail ?>">
                            </div>
                            ...
                            <div class=form__text>
                                <label for>姓名</label>
                                <p class=style-inline ><? echo $Name ?></p>
                            </div>
                            <div class=form__text>
                                <label for>手機</label>
                                <p class=style-inline ><? echo $Phone ?> </p>
                            </div>
                            <div class=form__text>
                                <label for>生日</label>
                                <p class=style-inline><? echo $Date ?> </p>
                            </div>
                        </div>
                    </div>
                </form>
