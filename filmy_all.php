...
<body style=background:#000000>
    ...
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                ...
                <ul class=member>
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href="SignUp.php"></a></li>
                    <li  class=top_btn_recommend><span id=slight_1 style=display:none></span><a href="filmy_all.php"></a></li>
                    <li class=top_btn_subscription><span id=topBar_light_2 style=display:none></span><a href="personal.php"></a></li>
    ...
    $conn=OpenCon("MIS");    
    $sql="SELECT * FROM Film_NotBuy WHERE FilmName='".$FilmName."'";
    ...
    $vote+=1;
$sql="UPDATE Film_NotBuy SET Vote='".$vote."' WHERE FilmName='".$FilmName."'";
           ...
           function change(elmnt,clr){
                   ...
                   k=0;
                   elmnt.style.backgroundColor = 'rgba(0,0,0,0.5)';
               }
...
if(!mysqli_query($conn,$sql)){
               echo"fail";
                ...
                if($num>0){
                   ...
                   <li><div id="k" class='order' onmouseup="change(this,'#EA7B94')">
                       <?
                        echo"<i class='material-icons'>favorite</i></div><a href='play.php' name='".$FilmName."'class='animelook'><div class='pic lazyloaded' data-bg='https://p2.bahamut.com.tw/B/ACG/c/71/0000108371.JPG' style='background-image:url(".$photo."'><div class='picinfo'><span class='newanime-count'><i class='i-material-icon-eye'></i></span></div></div></a><div class='info'><b>名稱：" .$FilmName. "</b><br>種類：".$Category."</div></li>";
