...
$query = "SELECT Category FROM Film_Buy GROUP BY Category
...
<html xmlns="http://www.w3.org/1999/xhtml" lang=zh-Hant-TW style>
...
function drawMonthwiseChart(chart_data, chart_main_title)
{
    ...
    data.addColumn('number', 'ClickTimes');
    $.each(jsonData,function(i,jsonData){
        var category = jsonData.Category;
        var clicktimes = parseInt(jsonData.ClickTimes);
        data.addRows([[category, clicktimes]]);
    });
    var options = {title:chart_main_title,
        hAxis: {
            title: "影片種類"
        },
        vAxis: {
...
function load_monthwise_data2(title)
{   
    $.ajax({
        url:"second.php",
        method:"POST",
        ...
        dataType:"JSON",
        success:function(data){
            drawMonthwiseChart2(data, title);   
        }
    });
}

function drawMonthwiseChart2(chart_data2, chart_main_title)
{
    var jsonData = chart_data2;
    var data2 = new google.visualization.DataTable();
    data2.addColumn('number', 'Age');
    data2.addColumn('number', 'Count');
    $.each(jsonData,function(i,jsonData){
        var age = parseInt(jsonData.Age);
        var count = parseInt(jsonData.Count);
        data2.addRows([[age, count]]);
    });
    var options2 = {title:chart_main_title,
        hAxis: {
            title: "年齡區間"
        },
        vAxis: {
...
$(document).ready(function(){
    load_monthwise_data('各種類影片觀看次數');
    load_monthwise_data2('會員年齡');
});
</script>
...
<link type=image/x-icon rel="shortcut icon" href="https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg%3E">
<style>
    .sf-hidden {
...
<body background="C:\Users\USER\Desktop\try\background.jpg">
    <noscript>
    ...
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                <div class=logo>
                    <a href="" /><img src="https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg%3E"></a>
                </div>
    ...
    <nav style=background:#000000 class="mainmenu on_top">
        ...
        <div></div>
            <ul>
                ...
                <li style=background:#000000><a href="../../filmy/admin/filmy_no_like_supervisor.php">所有影音</a></li>

<li style=background:#000000><a href= "../../filmy/admin/問題回報New_supervisor.php">問題回報</a></li>
<li style=background:#000000><a href="../../filmy/admin/會員管理new.php">會員管理</a></li>
<li style=background:#000000><a href="../../filmy/admin/會員管理影片new.php">影片管理</a></li>
<li style=background:#000000><a href="../../filmy/admin/未購入影片.php">未購入影片清單</a></li>
<li style=background:#FFCC6E><a href="../../complete/test/page.php">趨勢分析</a></li>
...
<div class="container">  
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="chart_area1" style="width: 800px; height: 620px;"></div>
                    <div id="chart_area2" style="width: 800px; height: 620px;"></div>
                </div>
            </div>
        </div>
