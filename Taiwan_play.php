...
<body style=background:#000000>
    <noscript>
        <iframe src="/Users/huangjujie/Desktop/Database/初戀那天所讀的故事.mp4"
            ...
            <div class=container-player>
                ...
                <ul class=member>
                    ...
                    <li class=top_btn_recommend><span id=topBar_light_2 style=display:none></span><a href="filmy_all.php"></a>
                        <li class=top_btn_subscription><span id=topBar_light_1 style=display:none></span><a href="personal.php"></a>
...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $vote+=1;
$sql="UPDATE Film_NotBuy SET Vote='".$vote."' WHERE FilmName='".$id."'";
    ...
    include "db_connection.php";
    $conn=OpenCon("MIS");    
    $sql="SELECT * FROM Film_Buy WHERE FilmName='炮仔聲'";
    $rows=mysqli_query($conn,$sql);
    $row=mysqli_fetch_array($rows);
    ...
    $vote+=1;
    $date=date("Y-m-d");
$sql="UPDATE Film_Buy SET ClickTimes='".$vote."' WHERE FilmName='".$FilmName."'";
               if(!mysqli_query($conn,$sql))
                   echo "更新紀錄失敗...<br/>".mysqli_error($conn);
                else{
                    echo "更新紀錄成功...<br/>"; 
                }
    $sql="INSERT INTO Record (email,FilmName,view_time) VALUES('$email','$FilmName','$date')";
               if(!mysqli_query($conn,$sql))
                   echo "更新紀錄失敗...<br/>".mysqli_error($conn);
                else{
                    echo "更新紀錄成功...<br/>"; 
    ...
    <div class= title>
        <div class="keepcenter">
            <video id="movie" preload controls loop poster="poster.png" width="1280" height="720">
                <source <iframe width="1191" height="670" src="台劇.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>>
                <source />
            </video>
            <div style=background:#FFCC6E class=footer>Filmy網路資訊股份有限公司 <span>© Oneup Network Corporation All Rights Reserved.</span><br><span><a href=https://ani.gamer.com.tw/animeRule.php target=_blank>服務條款</a></span>｜本網站已依台灣網站內容分級規定處理｜<span>法律顧問: 小紅科技法律事務所</span><br></div>
            <div style="position:fixed;left:20px;right:20px;bottom:20px;z-index:99;display:none;padding:15px 30px 15px 15px;border:1px solid transparent;border-radius:3px;line-height:1.5;background:#FFFFDB;border-color:#E1D3B8;color:#705930">
