...
<meta name=thumbnail content=https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg>
<meta property=og:title content=所有動畫>
<meta property=og:type content=website>
<meta property=og:url content=https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg>
<meta property=og:image content=https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg>
...
<style id=dialogifyCss>
    ...
    * {
    ...
    ul.member {
        ...
        ul.member .top_btn_subscription a:after {
            content: "\1F464"
        }
...
<link type=image/x-icon rel="shortcut icon" href="https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg">
<style>
    .sf-hidden {
...
<body style=background:#000000>
    ...
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                <div class=logo>
                    <a href= /><img src="https://1.bp.blogspot.com/-Il9h7ZY7FMA/Xri0WTR1T3I/AAAAAAAAE0c/_IUh3VNyMoUapYqLDDh7U_lUwewXaB8lQCNcBGAsYHQ/s1600/logo.jpg"></a>
                </div>
                <form id=frm1215  method="post">
                    <div class=search>
                        <input type=text name="write"id="write" value>
                        <button style=background:#FFCC6E type="submit" name="Search"><i style=background:#FFCC6E class=material-icons>search</i></button>
                    </div>
                </form>
            
                <ul class=member>
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href=></a>
                    <li  class=top_btn_recommend><span id=slight_1 style=display:none></span><a href="filmy_all.php"></a>
                    <li class=top_btn_subscription><span id=topBar_light_2 style=display:none></span><a href="personal.php"></a>
                    <li class=head><a href="">
                        </ul>
            </div>
            <div id=topBarMsg_light_1 style=display:none></div>
            <div onmousedown="通知" id=topBarMsg_light_2 style=display:none></div>
            <div id=topBarMsg_hahamut style=display:none></div>
            <div id=topBarMsg_more style=display:none></div>
        </div>
    </div>
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            ...
            <ul>
                ...
                <li style=background:#FFCC6E><a href="filmy_no_like.php">所有影音</a></li>
                <li style=background:#000000><a href="filmy_mine.php">觀看記錄</a></li>
                <li style=background:#000000><a href="charge.php">付費方案</a></li>
                <li style=background:#000000><a href="">常見問題</a></li>
                <li style=background:#000000><a href="" target=_blank>問題回報</a></li>
            </ul>
        </div>
    </nav>
    <div class= title>
    ...
    <ul class="anime_list">
                <?
        include "../complete/db_connection.php";
    $conn=OpenCon("MIS");
    if(!$conn){
        die("error!!!".mysqli_connect_error());
    }
        if(isset($_POST["Search"])){
    $SearchResult=$_POST["write"];

$str = "SELECT * FROM Member WHERE Name LIKE '%" . $SearchResult . "%' OR FilmName LIKE '%" . $SearchResult . "%'";
    $rows=mysqli_query($conn,$str);
...
if(!mysqli_query($conn,$str)){
 ...
 echo"   <tr>
      <td id='color2'  bgcolor=#FFCC6E><div align='center'><strong>姓名</strong></div></td>
      <td id='color2'  bgcolor=#FFCC6E><div align='center'><strong>email</strong></div></td>
      <td id='color2'  bgcolor=#FFCC6E><div align='center'><strong>Date</strong></div></td>
      <td id='color2'  bgcolor=#FFCC6E><div align='center'><strong>權限</strong></div></td>
      <td id='color2'  bgcolor=#FFCC6E><div align='center'><strong>管理</strong></div></td>
    </tr>";
                    }
    ...
    $num=mysqli_num_rows($rows);
    echo"<table  colspan='5' style='border-color:#FFCC6E text-align: center;background:black' border='2'>
        
        <tr>
            <td style='height: 5px;width: 10px;vertical-align: middle;'><h3 style='color: white'>編號</h3></td>
            <td style='height: 5px;width: 200px;background: #000000'><h3 style='color: white;'>姓名</h3></td>
            <td style='height: 5px;width: 200px;background: #000000'><h3 style='color: white;'>email</h3></td>
            <td style='height: 5px;width: 200px;background: #000000'><h3 style='color: white;'>生日</h3></td>
            <td style='height: 5px;width: 200px;background: #000000'><h3 style='color: white;'>功能</h3></td>
        </tr>";
                 $id=0;
                if($num>0){
    ...
    <tr>
            <td style='height: 5px;width: 200px'><h3 style='color: white'>".$id."</h3>
            </td>
            <td style='height: 5px;width: 200px'><h3 style='color: white'>".$Name."</h3>
            </td>
            <td style='height: 5px;width: 200px;vertical-align: middle;'><h3 style='color: white'>".$email."</h3></td>
            <td style='height: 5px;width: 200px;background:#000000'><h3 style='color: white'>".$Date."</h3></td>
            <td><div align='center'>
      <div class='btn-group'>
      <button class='btn' id='".$email."'type='submit'>刪除</button>
      </div>
      </div></td>
        </tr>
        </tr>";
