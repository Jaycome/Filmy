...
?>
<!DOCTYPE html>
<html lang=zh-Hant-TW style>

<meta charset=utf-8>
<title>Welcome Filmy</title>
<meta name=viewport content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<meta name=description content=付費就免費的影音平台>
<meta name=thumbnail content=C:\Users\USER\Desktop\try\logo>
<meta property=og:title content=所有動畫>
<meta property=og:type content=website>
<meta property=og:url content=C:\Users\USER\Desktop\try\logo>
<meta property=og:image content=C:\Users\USER\Desktop\try\logo>
<meta property=og:description content=付費就免費的影音平台>
...
<style id=dialogifyCss>
    ...
    html, body, div, span, h1, p, a, img, b, i, ul, li, form, nav, section {
        margin: 0;
        padding: 0;
        border: 0;
        font-size: 100%;
    ...
    body {
        ...
        font-family: "Helvetica Neue","Helvetica","Arial","PingFangTC-Light","STHeitiTC-Light","Microsoft JhengHei",sans-serif;
        font-weight: normal;
        font-size: 1em;
        min-width: 320px
    }
    ...
    * {
    ...
    ul.member {
        ...
        ul.member .top_btn_notice a:after {
            content: '';
            display: inline-block;
            margin: 17px 0 0 0;
            width: 22px;
            height: 22px;
            background-image: url(data:image/svg+xml;base64,);
            background-size: cover
        }

        ul.member .top_btn_notice a:hover:after {
            background-image: url(data:image/svg+xml;base64,)
        }

        ul.member .top_btn_head a:after {
            content: "\1F464"
        }

        ul.member .top_btn_recommend a:after {
            content: "\f164"
        }
    ...
    @-webkit-keyframes bannerBackground {
        from {
    ...
    .arrange {
        ...
        .arrange a {
            ...
            .arrange a:hover, .arrange .title a:focus {
                color: #00B4D8
            }
    ...
    .page_control {
        ...
        .page_control .arrow_container {
            ...
            .page_control .arrow_container > div {
                background: #64b8df
            }

                .page_control .arrow_container > div:nth-of-type(1) {
                    width: 11px;
                    height: 3px;
                ...
                .page_control .arrow_container > div:nth-of-type(2) {
                    width: 11px;
                    height: 3px;
                    -webkit-transform: rotate(-45deg);
                    transform: rotate(-45deg);
            ...
            .page_control .arrow_container.is-left {
                -webkit-transform: rotate(180deg);
                transform: rotate(180deg)
            }

            .page_control .arrow_container.is-none > div {
                background: #b7b7b7
            }
        ...
        .page_control .page_number {
            ...
            .page_control .page_number a {
                ...
                text-decoration: none;
                font-weight: 500;
                -webkit-box-shadow: 0 0 1.7px 1px rgba(0,0,0,0.08);
                box-shadow: 0 0 1.7px 1px rgba(0,0,0,0.08)
            }

                .page_control .page_number a:hover, .page_control .page_number a:focus {
                    background: #469bbc;
                    color: #fff
                }

            .page_control .page_number .now {
                background: #469bbc;
                color: #fff
            }
        ...
        .page_control a.prev {
            ...
            .page_control a.prev:hover, .page_control a.prev:focus {
                background: #469bbc
            }

                .page_control a.prev:hover .arrow_container > div, .page_control a.prev:focus .arrow_container > div {
                    background: #d2e6ee
                }
        ...
        .page_control a.next {
            ...
            .page_control a.next:hover, .page_control a.next:focus {
                background: #469bbc
            }

                .page_control a.next:hover .arrow_container > div, .page_control a.next:focus .arrow_container > div {
                    background: #d2e6ee
                }
    ...
    body .BH_background .container .old_list ul li .animelook .pic .picinfo .newanime-count {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        margin-top: 3px;
        ...
        body .BH_background .container .old_list ul li .animelook .pic .picinfo .newanime-count .i-material-icon-eye {
            margin-right: 4px;
            ...
            background-image: url(data:image/png;base64,)
        }

    body .old_list .newanime-count:nth-child(2) {
        margin-left: 4px
    }

    body .BH_background .container .old_list ul li .animelook .pic .picinfo {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        position: absolute;
...
<link type=image/x-icon rel="shortcut icon" href="C:\Users\USER\Desktop\try\logo.png">
<style>
    .sf-hidden {
        display: none !important
    }
</style>
<style> .bt{ border: none; /* 去掉邊框 */ background: #FFCC6E; /* 改背景色 */ color: black; /* 字改成白色 */ font-size: 28px; /* 改字體大小 */ padding: 20px; /* 按鈕內邊距離 */ width: 150px; /* 按鈕寬度 */ border-radius: 5px; /* 圓角5px */ } .bt span{ transition: 0.5s; /* 過渡0.5秒 */ } .bt:hover span{ padding-right: 25px; /* 當滑鼠在按鈕上時span內邊右距離25px */ } .bt span:after{ content: "»"; /* span後面追加內容為» */ opacity: 0; /* 透明度為0 */ transition: 0.5s; /* 加個0.5秒的過渡 */ } .bt:hover span:after{ opacity: 1; /* 透明度為1，就是顯示 */ } </style>
<link rel=canonical href=></head>
<body style=background:#000000>
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NDWB6QP"
                height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
    <div class=top_sky>
        <div style=background:#000000 class=sky>
            <div class=container-player>
                <div class=logo>
                    <a href=https://cn.pornhub.com /><img src="logo.png"></a>
                </div>
                <form id=frm1215 action=search.php method=GET>
                    <div class=search>
                        <input type=text name=kw value>
                        <button style=background:#FFCC6E type=submit><i style=background:#FFCC6E class=material-icons>search</i></button>
                    </div>
                </form>
                <ul class=member>
                    <li class="searchbtn sf-hidden"><a href=></a>
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href=></a>
                    <li class=top_btn_head><span id=topBar_light_1 style=display:none></span><a href=></a>
                    <li class=top_btn_recommend><span id=topBar_light_2 style=display:none></span><a href=></a>
                    <li class=head><a href=>
            </div><div id=topBarMsg_light_1 style=display:none></div><div id=topBarMsg_light_2 style=display:none></div><div id=topBarMsg_hahamut style=display:none></div><div id=topBarMsg_more style=display:none></div>
        </div>
    </div>
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            <div class="menu_btn toggle sf-hidden">
                <i class=material-icons>menu</i>
            </div>
            <ul>
                <li style=background:#000000><a href="">首頁</a></li>
                <li style=background:#000000><a href="">所有影音</a></li>
     <li style=background:#000000><a href="">觀看記錄</a></li>
                <li style=background:#000000><a href="">我的影音</a></li>
                <li style=background:#000000><a href=>付費方案</a></li>
                <li style=background:#FFCC6E><a href= target=_blank>問題回報</a></li>
    ...
    <div class= title>
        <h1>所有影音</h1>
        <div class=arrange><a href="" class=now><i class=material-icons>arrow_drop_down_circle</i><span>依作品新舊</span></a><a href=""><i class=material-icons>arrow_drop_down_circle</i><span>依單月人氣</span></a></div>
    </div>
    </section><div class=page_control>
        <a style=background:#FFCC6E class=prev href=><div class="arrow_container is-none is-left"><div></div><div></div></div></a>
    </div>
    </div>
...
<h1 class="kb-title"><font  color="white">Filmy 是什麼？</font></h1><br><br>
<img class="image" src="https://help.nflxext.com/61d4de82-c777-48af-8985-e4e7f707f015_icon_help_en.png">
                        <h2><font size="2" color="white">Filmy串流</font></h2>
<font size="2" color="white">Filmy 是一種串流服務，可讓會員在數千種可上網行動裝置上，觀賞各種</font><br>
<font size="2" color="white">獲獎肯定的節目、電影、紀錄片及更多內容。 您可以在 Filmy 上不受限制</font><br>
<font size="2" color="white">地觀賞任何內容，而且不會有任何廣告。 時時刻刻都有全新內容等您來發</font><br>
<font size="2" color="white">掘，而且每個月都會加入新的節目和電影！</font></p><br>

<font size="2" color="white">如果您已是會員，並且想進一步了解 Filmy 的使用方式，請參考開始使用</font><br>
<font size="2" color="white"> Filmy。</font><br>
    ...
    <div class="c-wrapper">
       ...
       <br><br> <hr width="60%"><br><br>
        <div class="two-cols">
            <div class="c-col split_30">
                <div class="c-wrapper">
                    <div class="c-image"><img class="image" src="https://
					help.nflxext.com/7634f2bf-1733-4a69-b20a-3e6e19598404_icon_membership_en.png" alt=""  ></div>
                </div>
            ...
            <div class="c-col">
                <div class="c-wrapper">
                    <div>
                        <h2><font size="2" color="white">會員資格</font></h2>
                        <p><font size="2" color="white">各種價格方案，任您挑選！ Filmy 提供 單一會員資格方案</a>，來滿足您不同的需求。<br> 您使用的方案將決定同時能有多少人串流 Filmy 內容，以及可採用<br>的播放畫質為標準畫質 (SD)、高畫質 (HD) 或超高畫質 (UHD)。</p>
                        <ul>
                            <li><p><strong>1.基本方案</strong>：1 個螢幕方案 SD（可同時在 1 個裝置上觀賞，標準畫質，不需要看廣告）</p>
                            </li>
                           <li><p><strong>2.免費方案</strong>：1 個螢幕方案 SD（可同時在 1 個裝置上觀賞，標準畫質，但需要看廣告）</p>
                            </li>
                        </ul>
                        <p>您成為 Filmy 會員後，系統將會於每個月您當初註冊的那一日收費。<br> 若要深入了解收費資訊，請參考我們的收費常見問題</a>。</p>
                        <p>您可以從帳戶</a>頁面隨時更換或升級您的方案</a>。</font></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="two-cols">
            <div class="c-col split_30">
                <div class="c-wrapper">
                    <div class="c-image"><img class="image" src="https://help.nflxext.com/c689aaed-9ee4-4281-bd83-95ec26e8f405_icon_play_en.png" alt=""></div>
                </div>
            </div>
            <div class="c-col">
                <div class="c-wrapper">
                    <div>
                        <h2><font size="2" color="white">節目與電影</h2>
                        <p>Filmy 會員能在超過 190 個國家/地區</a>即時存取精彩內容。 Filmy 擁有影片<br>豐富的全球媒體內容庫，包括</a>。 Filmy 提供的內容依地區而異，也可能隨時間而異。</p>
                        <p>隨著您觀賞的內容越多，Filmy 越能根據您的喜好，推薦節目與電影給您。</p>
                        <p>您可以選擇播放、暫停和接續播放，而且全無廣告，也不須綁約。</font></p>
        ...
        <div class="two-cols">
            <div class="c-col split_30">
                <div class="c-wrapper">
                    <div class="c-image"><img class="image" src="https://help.nflxext.com/9df7b1a0-7350-40bb-8414-c4bc1e3c1347_icon_getstarted_en.png" alt=""></div>
                </div>
            </div>
            <div class="c-col">
                <div class="c-wrapper">
                    <div>
                        <h2><font size="2" color="white">開始吧！</h2>
                        <p>依照以下簡單步驟，即可立即開始觀賞 Filmy：</p>
                        <ol>
                            <p>1.選擇適合您的會員資格方案。</p>
                            
                            <p>2.輸入您的電郵地址並建立密碼，來建立帳戶。</p>
                            
                            <p>3.輸入可用的付款方式。</p>
                            
                            <p>4.就這樣！ 開始串流吧！</font></p>
                        ...
                        <p><font size="2" color="white">您成為 Filmy 會員後，我們將以您當初註冊的那一日為準，<font size="2" color="red">按月計費</font>。 <br>若您覺得 Filmy 不適合您，您可以選擇隨時<font size="2" color="red">線上取消</font></font></a>。</p>
                    <br><br> <label for="problem"><font color="white" size="5">還是有問題嗎?請回報給我們，很榮幸為您解答</font> </label>
                <br><input type="input" class="form-control" id="problem" style="font-size:42px">
				  <button type="submit" class="bt" ><span> 送出</span></button>
					</form>
					</div>
                </div>
            </div>
        ...
        <div>
            <div>
<span data-type="RC" data-tnid="2243"> 
<div class="page-block">
    <div class="c-wrapper">
        <div>
            <p></p>
...
<script>
	$(document).on("ready", function(){
    		...
    		$("#add_article_form").on("submit", function(){
    			...
    			if($("#problem").val() == '' ){
    				...
    				$("div.loading").html('');
					  ...
					  //使用 ajax 送出 帳密給 verify_user.php
						$.ajax({
	            type : "POST",
	            url : "php/add_problem.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
	              
	              content : $("#problem").val(), //使用者帳號
	            ...
	            if(data == "yes")
	            {
	              //註冊新增成功，轉跳到登入頁面。
	              alert("傳送成功，點擊確認回列表");
	              window.location.href = "常見問題new.php";
	            }
	            else
	            {
	              alert("新增 施拜"+data);
	...
	<div style=background:#FFCC6E class=footer>Filmy網路資訊股份有限公司 <span>© Oneup Network Corporation All Rights Reserved.</span><br><span><a href=https://ani.gamer.com.tw/animeRule.php target=_blank>服務條款</a></span>｜本網站已依台灣網站內容分級規定處理｜<span>法律顧問: 小紅科技法律事務所</span><br></div><div style="position:fixed;left:20px;right:20px;bottom:20px;z-index:99;display:none;padding:15px 30px 15px 15px;border:1px solid transparent;border-radius:3px;line-height:1.5;background:#FFFFDB;border-color:#E1D3B8;color:#705930">
        <a href= class=alert-close>
        </a>
        <p style=color:#705930;font-size:1.4em;padding:0>我們了解您不想看到廣告的心情⋯ 若您願意支持Filmy永續經營，請小額資助我們，謝謝 !</p>
    </div>
