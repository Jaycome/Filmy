...
<li style=background:#FFCC6E><a href= "問題回報New.php">問題回報</a></li>
<li style=background:#000000><a href="會員管理new.php">會員管理</a></li>
<li style=background:#000000><a href="會員管理影片new.php">影片管理</a></li>
<li style=background:#000000><a href="未購入影片.php">未購入影片清單</a></li>
<li style=background:#000000><a href="趨勢分析.php">趨勢分析</a></li>
<li role="presentation" role="presentation"><a href="../php/logout.php">登出</a></li>
            </ul>
        </div>
    </nav>
    </div>
...
<div class="container" style="text-align:center;width:900px;">
  <table bgcolor="black" width="900" border="1" class="table table-bordered table-condensed table-striped table-hover">
    <tr>
      <td colspan="3"  bgcolor=#FFCC6Ev><div align="center"><strong><h2>影片管理</h2></strong></div></td>
    </tr>
    
   <tr>
                <th><font color="white">項次</font></th>
                <th><font color="white">問題</font></th>
				<th><font color="white">回覆</font></th>
                
              </tr>
              <?php if($articles):?>
                <?php foreach($articles as $article):?>
                  <tr>
                    <td><font color="white"><?php echo $article['category'];?></font></td>
                    <td><font color="white"><?php echo $article['title'];?></font></td>
					
                    <td>
                      <a href='影片內容編輯.php?i=<?php echo $article['id'];?>' class="btn btn-default">回復</a>
              ...
              <?php else:?>
                <tr>
                  <td colspan="3"><font color="white">無資料</font></td>
                </tr>
              <?php endif;?>
