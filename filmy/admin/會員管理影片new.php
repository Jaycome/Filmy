...
<li style=background:#000000><a href="../../complete/test/page.php">趨勢分析</a></li>
	...
	<div style="width:100%;text-align:center"><Form METHOD="POST" ACTION="新增影片.php">
<?php
...
<div class="container" style="text-align:center;width:900px;">
  <table bgcolor="black" width="900" border="1" class="table table-bordered table-condensed table-striped table-hover">
    <tr>
      <td colspan="6"  bgcolor=#FFCC6Ev><div align="center"><strong><h2>影片管理</h2></strong></div></td>
    </tr>
   ...
   <tr>
       ...
       <th><font color="white"><h2>上傳時間</h2></font></th>
               ...
               echo"fail";
                ...
                if($num>0){
					...
					<td><font color="white"><img src=<?php echo $photo;?>></font></td>
                      ...
                      <td><font color="white"><h2><?php echo $Date;?></h2></font></td>
                    <td>
                        <a href='影片內容編輯.php?id=<?php echo $FilmName;?>' class="btn btn-default"><h2>編輯</h2></a>
                ...
                <?php foreach($articles as $article):?>
                  <tr>
					...
					<td><font color="white"><img src=<?php echo $article['Photo'];?>></font></td>
                      ...
                      <td><font color="white"><h2><?php echo $article['DueDate'];?></h2></font></td>
                    <td>
                        <a href='影片內容編輯.php?id=<?php echo $article['FilmName'];?>' class="btn btn-default"><h2>編輯</h2></a>
                        <a href='javascript:void(0);' class='btn btn-default del_article' data-id="<?php echo $article['FilmName'];?>"><h2>刪除</h2></a>
              
                  </tr>
                <?php endforeach;?>
              <?php else:?>
                <tr>
                  <td colspan="6"><font color="white">無資料</font></td>
                </tr>
              <?php endif;?>
  <?}?>
  </table>
   <div class="row">
          ...
          <div class="col-xs-12">
            <button  class="bt">  <a href='新增未購入影片.php' class="btn btn-default"><strong>新增影片</strong></button></span></a>
          </div>
          <div class="col-xs-12">
</div> 
