...
<div class="container" style="text-align:center;width:900px;">
  <table bgcolor="black" width="900" border="1" class="table table-bordered table-condensed table-striped table-hover">
   ...
   <tr>
       ...
       <th><font color="white">答覆管理者</font></th>
    ...
    if($num>0){
                   ...
                   echo"<tr>
                    ...
                    <td><font color='white'>".$Q_mail."</font></td>
					<td><font color='white'>".$Answer."</font></td>
                    <td><font color='white'>".$S_account."</font></td>
                    <td><font color='white'><a href='問題回報New_result.php?UserID=".$id."'>回覆</a></font></td>
