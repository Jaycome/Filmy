          ...
          <div class="col-xs-12">
            <form id="add_article_form">
              <div class="form-group">
                ...
                <input type="input" class="form-control" id="title" style="font-size:22px">
              </div>
               <div class="form-group">
                ...
                <select id="category" class="form-control" style="font-size:42px">
                  ...
                  <option value="US"><font color="white" size="10">US</font ></option>
                ...
                <label for="supplier"><font color="white" size="5">供應商</label>
                <textarea type="input" class="form-control" id="supplier"></textarea>
              </div>	
              <div class="form-group">
			   ...
			   <div class="form-group">
                ...
                <textarea type="input" class="form-control" id="picture"></textarea>
              </div>
