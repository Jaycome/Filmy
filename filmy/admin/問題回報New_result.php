...
if(isset($_POST["send"])){
    ...
    $account=SESSION['PHPSESSID'];
    //echo"alert('".$S_mail."')";
    
    $sql="UPDATE Question SET `A_Content` = '{$A_Content}',`S_Account` = 'A123@a.com' WHERE QID='".$id."'";
    if(!mysqli_query($conn,$sql))
        echo "更新紀錄失敗...<br/>".mysqli_error($conn);
    else header("Location:問題回報New_supervisor.php");
}
else{
        ...
        <div style=background:#000000 class=sky>
            <div class=container-player>
                ...
                <ul class=member>
                    ...
                    <li class=top_btn_notice><span id=topBar_light_0 style=display:none></span><a href=../../complete/SignUp.php></a>
...
<div class="container" style="text-align:center;width:900px;">
  <table bgcolor="black" width="900" border="1" class="table table-bordered table-condensed table-striped table-hover">
    <tr>
      <td colspan="6"  bgcolor=#FFCC6Ev><div align="center"><strong><h2>你的問題</h2></strong></div></td>
    </tr>
    
   <tr>
                <th><font color="white">項次</font></th>
                <th><font color="white">問題</font></th>
       <th><font color="white">會員</font></th>
				<th><font color="white">答覆</font></th>
       <th><font color="white">答覆之管理者</font></th>
                <th><font color="white">功能</font></th>
              </tr>
                   ...
                   <tr>
                    ...
                    <td><font color='white'><label for="Question"></label><?php echo $content?></font></td>
                    <td><font color='white'><label for="email"></label><?php echo $email?></font></td>
					<td><font color='white'><input type='text' name='A_Content' id='A_Content' value="<?php echo $A_Content?>" >
                        </font></td>
                    <td><font color='white'><?php echo $S_Account?></font></td>
                 
                    <td><font color='white'><input type='submit' name='send' value='更新'></font></td>
