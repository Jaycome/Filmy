   ...
   <tr>
             <th><font color="white">email</font></th>
                ...
                <th><font color="white">生日</font></th>
				 <th><font color="white">電話</font></th>
...
$str = "SELECT * FROM Member WHERE Name LIKE '%" . $SearchResult . "%' OR Name LIKE '%" . $SearchResult . "%'";
...
if(!mysqli_query($conn,$str)){
               echo"fail";
                ...
                if($num>0){
                    while($row=mysqli_fetch_array($rows)){
                        ...
                        ?>
                  <tr>
				  <td><font color="white"><?php echo $email;?></td>
                      <td><font color="white"><?php echo $Name;?></td>
					
                    <td><font color="white"><?php echo $Date;?></td>
                   <td><font color="white"><?php echo $Phone;?></td>
                    <td>
                  
                      <a href='javascript:void(0);' class='btn btn-default del_member' data-email="<?php echo $Phone;?>">刪除</a>
                    </td>
                  </tr>
                <?
                    }
               ...
               <?php if($members):?>
                <?php foreach($members as $member):?>
                  <tr>
				  <td><font color="white"><?php echo $member['email'];?></td>
                      <td><font color="white"><?php echo $member['Name'];?></td>
					
                    <td><font color="white"><?php echo $member['Date'];?></td>
                   <td><font color="white"><?php echo $member['Phone'];?></td>
                    <td>
                  
                      <a href='javascript:void(0);' class='btn btn-default del_member' data-email="<?php echo $member['Phone'];?>">刪除</a>
                    </td>
                  </tr>
                <?php endforeach;?>
              <?php else:?>
   ...
   <div class="row">
    ...
    <script>
    	$(document).on("ready", function(){
            ...
            data : {
              'Phone' : $(this).attr("data-email") //使用者email
            },
