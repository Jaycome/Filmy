...
<li style=background:#000000><a href="../../complete/test/page.php">趨勢分析</a></li>
	...
	<div class="content" >
      <div class="container" style="text-align" >
        ...
        <div class="row" >
		  ...
		  <div class="col-xs-12" >
            <form id="add_article_form1" >
		
              <div class="form-group" >
			  
                <label for="title"><font color="white" size="5">影片</font> </label>
                <input type="input" class="form-control" id="title" style="font-size:32px">
              </div>
		
               <div class="form-group" >
                <label for="category"><font color="white" size="5">分類</font ></label>
                <select id="category" class="form-control" style="font-size:42px">
                 <option value="Taiwan"><font color="white" size="10">Taiwan</font ></option>
                  <option value="US"><font color="white" size="5">US</font ></option>
				   <option value="Korea"><font color="white" size="10">Korea</font ></option>
                  <option value="Japan"><font color="white" size="10">Japan</font ></option>
				   <option value="India"><font color="white" size="10">India</font ></option>
                  
                </select>
              </div>
              <div class="form-group" >
                <label for="content"><font color="white" size="5">連結</label>
                <textarea type="input" class="form-control" id="content" style="font-size:10px"></textarea>
              </div>
                  <div class="form-group" >
                <label for="content"><font color="white" size="5">供應商</label>
                <textarea type="input" class="form-control" id="supplier" style="font-size:10px"></textarea>
              </div>
                    
			   <div class="form-group">
                <label for="picture"><font color="white" size="5">圖片</label>
                <textarea type="input" class="form-control" id="picture" style="font-size:10px"></textarea>
              </div>
    ...
    <script>
    	$(document).on("ready", function(){
    		//表單送出
    		$("#add_article_form1").on("submit", function(){
    			
    			
    			if($("#title").val() == '' || $("#content").val() == ''|| $("#picture").val() == ''){
    				alert("請填入標題或內文");
					  ...
					  //使用 ajax 送出 帳密給 verify_user.php
						$.ajax({
	            type : "POST",
	            url : "../php/add_article1.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
	            data : {
