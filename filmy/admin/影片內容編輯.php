          ...
          <div class="col-xs-12">
            <form id="edit_article_form">
              ...
              <div class="form-group">
                ...
                <input type="input" class="form-control" id="FilmName" style="font-size:42px" value="<?php echo $data['FilmName'];?>">
              </div>
               <div class="form-group">
    	...
    	$(document).on("ready", function(){
    		...
    		$("#edit_article_form").on("submit", function(){
	            ...
	            if(data == "yes")
	            {
	              //註冊新增成功，轉跳到登入頁面。
	              alert("更新成功，點擊確認回列表");
	              window.location.href = "會員管理影片new.php";
	            }
	            else
	            {
	              alert("更新錯誤"+data);
