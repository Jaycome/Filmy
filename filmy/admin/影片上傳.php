...
<body background="https://images.pexels.com/photos/1624438/pexels-photo-1624438.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500">
    ...
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            ...
            <ul>
			 <a href="問題回報New.php"> 問</a>
                <li style=background:#000000><a href="首頁TEST聚光燈.html">首頁</a></li>
                <li style=background:#000000><a href="">所有影音</a></li>

<li style=background:#000000><a href= "問題回報New.php">問題回報</a></li>
<li style=background:#000000><a href="會員管理new.php">會員管理</a></li>
<li style=background:#FFCC6E><a href="會員管理影片new.php">影片管理</a></li>
<li style=background:#000000><a href="趨勢分析.php">趨勢分析</a></li>
            </ul>
        </div>
    </nav>
    </div>
...
<div class="container" style="text-align:center;width:900px;">
  <table bgcolor="black" width="900" border="1" class="table table-bordered table-condensed table-striped table-hover">
    <tr>
      <td colspan="5"  bgcolor=#FFCC6Ev><div align="center"><strong><h2>影片管理</h2></strong></div></td>
    </tr>
    
   <tr>
                <th><font color="white">影片名</font></th>
                <th><font color="white">圖片路徑</font></th>
                <th><font color="white">影片路徑</font></th>
                <th><font color="white">購入狀況</font></th>
                <th><font color="white">管理</font>z</th>
              </tr>
             <?php if($works):?>
                <?php foreach($works as $work):?>
                  <tr>
                    <td><font color="white"><?php echo $work['intro']; ?></font></td>
                    <td><font color="white"><?php echo $work['image_path']; ?></font></td>
                    <td><font color="white"><?php echo $work['video_path']; ?></font></td>
                    <td><font color="white"><?php echo($work['publish']) ? "發布" : "下架中"; ?></font></td>
                    <td>
   ...
   <div class="row">
          ...
          <div class="col-xs-12">
            <a href='新增影片.php' class="btn btn-default"><font color="white">新增影片</font></a>
          </div>
          <div class="col-xs-12">
</div> 
