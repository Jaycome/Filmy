...
<body >
<noscript><iframe src='https://www.googletagmanager.com/ns.html?id=GTM-NDWB6QP'
...
<ul>
                ...
                <li style=background:#FFCC6E><a href="charge.php">付費方案</a></li>
...
<div id='container'>
    <table  style='text-align: center;background:white' border='1'>
        <tr>
            <td>
            </td>
            <td style='height: 50px;width: 200px;vertical-align: middle;'><h1 style='color: black'>免費會員</h1></td>
            <td style='height: 50px;width: 200px;background: #FFCC6E'><h1 style='color: black;'>付費會員</h1></td>
        </tr>
        <tr>
            <td style='height: 150px;width: 200px'><h1 style='color: black'>費用</h1>
            </td>
            <td style='height: 150px;width: 200px;vertical-align: middle;'><h1 style='color: black'>NTD 0$/月</h1></td>
            <td style='height: 150px;width: 200px;background:#FFCC6E'><h1 style='color: black'>NTD 80$/月</h1></td>
        </tr>
        <tr>
            <td style='height: 150px;width: 200px'><h1 style='color: black'>費用方案</h1>
            </td>
            <td style='height: 150px;width: 200px;vertical-align: middle;'><h1 style='color: black'>免費專區</h1><br><h3>*需觀看廣告</h3></td>
            <td style='height: 150px;width: 200px;background:#FFCC6E'><h1 style='color: black'>數以萬計電影/影集任你看</h1><br><h3>*無廣告</h3><h3>*多項功能開放</h3></td>
        </tr>
