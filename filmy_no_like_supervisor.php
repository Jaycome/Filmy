    	...
    	$(document).on("ready", function(){
    		...
    		$("a.animelook").on("click", function(){
    			...
    			var this_tr = $(this).parent().parent();
					...
					$.ajax({
            type : "POST",
            url : "play.php", //因為此檔案是放在 admin 資料夾內，若要前往 php，就要回上一層 ../ 找到 php 才能進入 add_article.php
    ...
    <nav style=background:#000000 class="mainmenu on_top">
        <div style=background:#000000 class=container-player>
            ...
            <ul>
                ...
                <li style=background:#FFCC6E><a href="">所有影音</a></li>

<li style=background:#000000 role="presentation" ><a href= ".問題回報New.php">問題回報</a></li>
<li style=background:#000000 role="presentation" ><a href=".會員管理new.php">會員管理</a></li>
<li style=background:#000000 role="presentation" ><a href=".會員管理影片new.php">影片管理</a></li>
<li style=background:#000000 role="presentation" ><a href=".趨勢分析.php">趨勢分析</a></li>
            </ul>
        </div>
    </nav>
    <div class= title>
        <h1>所有影音</h1>
        <div></div>
        <div class=arrange><a href="filmy_no_like_new.php" class=now><i class=material-icons>arrow_drop_down_circle</i><span>依作品新舊</span></a><a href="filmy_no_like_Click.php"><i class=material-icons>arrow_drop_down_circle</i><span>依單月人氣</span></a></div>
    </div>
    <ul class="anime_list">
...
$str = "SELECT * FROM Film_Buy WHERE FilmName LIKE '%" . $SearchResult . "%' OR FilmName LIKE '%" . $SearchResult . "%'";
               ...
               echo"fail";
                ...
                if($num>0){
                    while($row=mysqli_fetch_array($rows)){
                        ...
                        $Date=$row["DueDate"];
                        $photo=$row["Photo"];
                        $Click=$row["ClickTimes"];
                        
                        echo"<li>
                        <a href='play.php' class='animelook' data-id='".$FilmName."'>
                        <div class='pic lazyloaded' data-bg='https://p2.bahamut.com.tw/B/ACG/c/71/0000108371.JPG' style='background-image:url(".$photo."'>
                        <div class='picinfo'>
                        <span class='newanime-count'>
                        <h1>".$Click. "</h1></span></div></div></a><div class='info'><b>" .$FilmName. "</b><br>".$Date."</div></li>";
                    }
...
if(!mysqli_query($conn,$sql)){
               echo"fail";
                ...
                if($num>0){
                   ...
                   echo"<li>
                        <a href='play.php' class='animelook' data-id='".$FilmName."' id='".$FilmName."'>
                        <div class='pic lazyloaded' data-bg='https://p2.bahamut.com.tw/B/ACG/c/71/0000108371.JPG' style='background-image:url(".$photo."'>
                        <div class='picinfo'>
                        <span class='newanime-count'>
                        <h1>".$Click. "</h1></span></div></div></a><div class='info'><b>" .$FilmName. "</b><br>".$Date."</div></li>";
