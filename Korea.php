...
<body style=background:#000000>
    ...
    $conn=OpenCon("MIS");    
    $sql="SELECT * FROM Film_Buy WHERE FilmName='梨泰院class'";
    ...
    <div class= title>
        <div class="keepcenter">
            <video id="movie" preload controls loop poster="poster.png" width="1280" height="720">
                <source <iframe width="1191" height="670" src="韓劇.mp4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>>
                <source />
            </video>
